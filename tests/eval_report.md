...
```json
{
  ...
  "stop_pipeline": true,
  "validation_errors": [
    "The document blurry_bill.jpg is unreadable. Please re-upload."
  ],
  "fraud_flags": [],
  "decision": null,
  "notes": "The document blurry_bill.jpg is unreadable. Please re-upload.",
  "audit_trace": [
    {
      "node": "bouncer",
      "status": "PASSED"
...
```json
{
  ...
  "notes": "Treatment for diabetes requires a 90-day waiting period.",
  "audit_trace": [
    {
      "node": "bouncer",
      "status": "PASSED"
  ...
  "extracted_data": {
    ...
    "line_items": [
      ...
      },
      {
        ...
        "exclusion_reason": "Cosmetic Procedure"
      }
    ],
...
```json
{
  ...
  "notes": "Pre-authorization is required for MRI scans above 10,000.",
  "audit_trace": [
    {
      "node": "bouncer",
      "status": "PASSED"
...
```json
{
  ...
  "notes": "Claimed amount 7500.0 exceeds per-claim limit of 5000.",
  "audit_trace": [
    {
      "node": "bouncer",
      "status": "PASSED"
...
```json
{
  ...
  "decision": "APPROVED",
  "rejection_reasons": [],
  "notes": "Network discount (20%) applied first. Co-pay (10%) applied.",
  "audit_trace": [
    {
      "node": "bouncer",
      "status": "PASSED"
    ...
    "line_items": [
      {
        ...
        "amount": 3000.0,
        "is_policy_excluded": true,
        "exclusion_reason": "Obesity Treatment"
      },
      {
        "description": "Personalised Diet and Nutrition Program",
        "amount": 5000.0,
